...
Article.groupByTimeRead(1, ['my-list', 'archive'], true).then(data =>
  console.log('Article.groupByTimeRead ', data)
);

Article.groupByInteractionCount(1, ['my-list', 'archive'], true).then(data =>
  console.log('Article.groupByTimeRead ', data)
);
